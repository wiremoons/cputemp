...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#c632e4a1#;
   ...
   u00098 : constant Version_32 := 16#b37a0782#;
   pragma Export (C, u00098, "ada__directoriesB");
   u00099 : constant Version_32 := 16#18050e83#;
   pragma Export (C, u00099, "ada__directoriesS");
   u00100 : constant Version_32 := 16#9a2e29aa#;
   pragma Export (C, u00100, "ada__calendarB");
   u00101 : constant Version_32 := 16#c4f07049#;
   ...
   u00118 : constant Version_32 := 16#a6c9af38#;
   pragma Export (C, u00118, "system__float_controlS");
   u00119 : constant Version_32 := 16#16458a73#;
   pragma Export (C, u00119, "system__powten_tableS");
   u00120 : constant Version_32 := 16#ab4ad33a#;
   pragma Export (C, u00120, "ada__directories__validityB");
   u00121 : constant Version_32 := 16#498b13d5#;
   pragma Export (C, u00121, "ada__directories__validityS");
   u00122 : constant Version_32 := 16#adb6d201#;
   pragma Export (C, u00122, "ada__strings__fixedB");
   u00123 : constant Version_32 := 16#a86b22b3#;
   pragma Export (C, u00123, "ada__strings__fixedS");
   u00124 : constant Version_32 := 16#60da0992#;
   pragma Export (C, u00124, "ada__strings__searchB");
   u00125 : constant Version_32 := 16#c1ab8667#;
   pragma Export (C, u00125, "ada__strings__searchS");
   u00126 : constant Version_32 := 16#a3db8081#;
   pragma Export (C, u00126, "ada__strings__unboundedB");
   u00127 : constant Version_32 := 16#f39c7224#;
   pragma Export (C, u00127, "ada__strings__unboundedS");
   u00128 : constant Version_32 := 16#d398a95f#;
   pragma Export (C, u00128, "ada__tagsB");
   u00129 : constant Version_32 := 16#12a0afb8#;
   pragma Export (C, u00129, "ada__tagsS");
   u00130 : constant Version_32 := 16#796f31f1#;
   pragma Export (C, u00130, "system__htableB");
   u00131 : constant Version_32 := 16#c2f75fee#;
   pragma Export (C, u00131, "system__htableS");
   u00132 : constant Version_32 := 16#089f5cd0#;
   pragma Export (C, u00132, "system__string_hashB");
   u00133 : constant Version_32 := 16#60a93490#;
   ...
   u00157 : constant Version_32 := 16#620302a2#;
   pragma Export (C, u00157, "system__file_attributesS");
   u00158 : constant Version_32 := 16#198dbba9#;
   pragma Export (C, u00158, "system__os_constantsS");
   u00159 : constant Version_32 := 16#71ac0ba7#;
   ...
   u00166 : constant Version_32 := 16#e18a47a0#;
   pragma Export (C, u00166, "ada__float_text_ioB");
   u00167 : constant Version_32 := 16#1fef695b#;
   pragma Export (C, u00167, "ada__float_text_ioS");
   u00168 : constant Version_32 := 16#927a893f#;
   pragma Export (C, u00168, "ada__text_ioB");
   u00169 : constant Version_32 := 16#5194351e#;
   pragma Export (C, u00169, "ada__text_ioS");
   u00170 : constant Version_32 := 16#d5f9759f#;
   pragma Export (C, u00170, "ada__text_io__float_auxB");
   u00171 : constant Version_32 := 16#48248c7b#;
   pragma Export (C, u00171, "ada__text_io__float_auxS");
   u00172 : constant Version_32 := 16#181dc502#;
   pragma Export (C, u00172, "ada__text_io__generic_auxB");
   u00173 : constant Version_32 := 16#16b3615d#;
   pragma Export (C, u00173, "ada__text_io__generic_auxS");
   u00174 : constant Version_32 := 16#8aa4f090#;
   pragma Export (C, u00174, "system__img_realB");
   u00175 : constant Version_32 := 16#819dbde6#;
   pragma Export (C, u00175, "system__img_realS");
   u00176 : constant Version_32 := 16#3e932977#;
   pragma Export (C, u00176, "system__img_lluB");
   u00177 : constant Version_32 := 16#3b7a9044#;
   pragma Export (C, u00177, "system__img_lluS");
   u00178 : constant Version_32 := 16#1e40f010#;
   pragma Export (C, u00178, "system__fat_fltS");
   u00179 : constant Version_32 := 16#98936cef#;
   pragma Export (C, u00179, "get_linuxB");
   u00180 : constant Version_32 := 16#a5cb85e5#;
   pragma Export (C, u00180, "get_linuxS");
   u00181 : constant Version_32 := 16#5bc1f8e3#;
   pragma Export (C, u00181, "ada__text_io__unbounded_ioS");
   u00182 : constant Version_32 := 16#27d2953a#;
   pragma Export (C, u00182, "ada__strings__unbounded__text_ioB");
   u00183 : constant Version_32 := 16#2e5d93ef#;
   pragma Export (C, u00183, "ada__strings__unbounded__text_ioS");
   u00184 : constant Version_32 := 16#b5988c27#;
   pragma Export (C, u00184, "gnatS");
   u00185 : constant Version_32 := 16#b8c1d9f8#;
   pragma Export (C, u00185, "gnat__command_lineB");
   u00186 : constant Version_32 := 16#d602660e#;
   pragma Export (C, u00186, "gnat__command_lineS");
   u00187 : constant Version_32 := 16#c58b51c3#;
   pragma Export (C, u00187, "gnat__directory_operationsB");
   u00188 : constant Version_32 := 16#8f1a5551#;
   pragma Export (C, u00188, "gnat__directory_operationsS");
   ...
   u00192 : constant Version_32 := 16#2323a8af#;
   ...
   u00195 : constant Version_32 := 16#fcd606d0#;
   pragma Export (C, u00195, "gnat__stringsS");
   u00196 : constant Version_32 := 16#369e155e#;
   pragma Export (C, u00196, "gnat__socketsB");
   u00197 : constant Version_32 := 16#a6a830c3#;
   pragma Export (C, u00197, "gnat__socketsS");
   u00198 : constant Version_32 := 16#cb835252#;
   pragma Export (C, u00198, "gnat__sockets__linker_optionsS");
   u00199 : constant Version_32 := 16#b0810072#;
   pragma Export (C, u00199, "gnat__sockets__thinB");
   u00200 : constant Version_32 := 16#c5872358#;
   pragma Export (C, u00200, "gnat__sockets__thinS");
   u00201 : constant Version_32 := 16#357666d8#;
   pragma Export (C, u00201, "ada__calendar__delaysB");
   u00202 : constant Version_32 := 16#2da855d5#;
   pragma Export (C, u00202, "ada__calendar__delaysS");
   u00203 : constant Version_32 := 16#485b8267#;
   pragma Export (C, u00203, "gnat__task_lockS");
   u00204 : constant Version_32 := 16#05c60a38#;
   pragma Export (C, u00204, "system__task_lockB");
   u00205 : constant Version_32 := 16#27bfdb6a#;
   pragma Export (C, u00205, "system__task_lockS");
   u00206 : constant Version_32 := 16#305d23a5#;
   pragma Export (C, u00206, "gnat__sockets__thin_commonB");
   u00207 : constant Version_32 := 16#fdbccd6b#;
   pragma Export (C, u00207, "gnat__sockets__thin_commonS");
   u00208 : constant Version_32 := 16#69f6ee6b#;
   pragma Export (C, u00208, "interfaces__c__stringsB");
   u00209 : constant Version_32 := 16#603c1c44#;
   pragma Export (C, u00209, "interfaces__c__stringsS");
   u00210 : constant Version_32 := 16#5de653db#;
   pragma Export (C, u00210, "system__communicationB");
   u00211 : constant Version_32 := 16#5f55b9d6#;
   pragma Export (C, u00211, "system__communicationS");
   u00212 : constant Version_32 := 16#637ab3c9#;
   pragma Export (C, u00212, "system__pool_sizeB");
   u00213 : constant Version_32 := 16#471ba45d#;
   pragma Export (C, u00213, "system__pool_sizeS");
   u00214 : constant Version_32 := 16#6eeb21c8#;
   pragma Export (C, u00214, "show_versionB");
   u00215 : constant Version_32 := 16#77260253#;
   pragma Export (C, u00215, "show_versionS");
   u00216 : constant Version_32 := 16#9c857b76#;
   pragma Export (C, u00216, "gnat__source_infoS");
   u00217 : constant Version_32 := 16#f65595cf#;
   pragma Export (C, u00217, "system__multiprocessorsB");
   u00218 : constant Version_32 := 16#7e997377#;
   pragma Export (C, u00218, "system__multiprocessorsS");
